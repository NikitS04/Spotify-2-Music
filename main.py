...
def process_playlist(playlist_url, progress_bar, status_label):
    ...
    for index, track in enumerate(tracks):
        ...
        if video_url:
            ...
            # Update the label instead of showing a pop-up
            status_label.setText(f"Downloaded: {track}")
...
class App(QWidget):
    ...
    def init_ui(self):
        ...
        # Status label to display current download status
    ...
    def start_download(self):
        ...
        # Pass the new status label to the process_playlist function
        process_playlist(playlist_url, self.progress_bar, self.status_label)
